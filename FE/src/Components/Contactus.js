            ...
            <div className="container-fluid row row-content">
                ...
                <div className="col-12 col-md-15">
                    ...
                    <Form className="myForm" onSubmit={handleSubmit}>
                        <Row form>
                        <Col md={15}>
                            <u><h1 style={{marginLeft:"400px"}}>For any query/booking contact us here</h1></u>
                                <br/>
                                <div class="col-lg-12">
                                    <br></br>
                                    <a href="https://api.whatsapp.com/send?phone=919978610820&text=Hi%20Welcome%20to%20Coffee%20Adda%20How%20can%20we%20help%20you?"> 
                                    <Icon icon="mdi:whatsapp" style={{fontSize:"100px", marginLeft:"650px"}}/></a>
                                    <br></br>
                                </div>
