...

    {
        <CardBody>
            <Form  onSubmit={handleSubmitClick}>
                ...
                {/* <Link to="/Login" className="color btn btn-primary btn-md btn-block mt-2"><span className="fa fa-sign-in-alt fa-lg"></span>Sign-up</Link> */}
            </Form>
        </CardBody>}
</Card>
</>
...
if(initialState.customer_or_service_provider=="false"){
    return(
        ...
        <div className="row container-fluid">
            ...
            <div className="col-5" >
            <Card className=" mt-5 mb-5 ">
                    <CardHeader className="color mt-3 d-flex justify-content-start" ><h4 className=" mt-2 " style={{fontSize:"100%"}}>Customer Information</h4></CardHeader>
